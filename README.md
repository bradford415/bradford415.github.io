...
* Brower Icon: to change the browser icon you can update the image her: `_includes/head/custom.html`; specifically, change the `.ico` image `<link rel="icon" href="/images/tropical-leaves-32x32.ico"/>`
  * I downloaded a png icon here: https://www.freepik.com/search?format=search&iconType=standard&last_filter=query&last_value=&type=icon#uuid=a855fe67-bc5e-4694-8ea6-4b3fa43dfa9f
  * Resized it to 32x32 with ms paint
  * Convert the `png` to `ico` here: https://cloudconvert.com/png-to-ico
  * And uploaded the image to the following directory: `/images`
